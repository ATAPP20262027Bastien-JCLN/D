...
VALUES
('Alice Martin',    'alice@example.com',    'test_password', 1),
('Bob Dupont',      'bob@example.com',      'test_password', 1),
('Charlie Bernard', 'charlie@example.com',  'test_password', 1),
('David Thomas',    'david@example.com',    'test_password', 1),
('Emma Petit',      'emma@example.com',     'test_password', 1),
('Lucas Robert',    'lucas@example.com',    'test_password', 1),
('Chloe Richard',   'chloe@example.com',    'test_password', 1),
('Hugo Durand',     'hugo@example.com',     'test_password', 1),
('Lea Moreau',      'lea@example.com',      'test_password', 1),
('Nathan Simon',    'nathan@example.com',   'test_password', 1);
